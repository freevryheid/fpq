module fpq_execute
  ...
  contains
    ...
    function execparams(conn, command, nparams, paramvalues, resultformat) result(pgresult)
      ...
      character(len=:), intent(inout), allocatable :: paramvalues(:)
        !!  Parameter values.
      ...
      integer :: i
      do i = 1, nparams
        paramvalues(i) = c_cst(paramvalues(i)
      end do
      pgresult%ptr = pqexecparams(conn &
        , c_str(command)               &
    ...
    function prepare(conn, stmtname, query, nparams) result(pgresult)
    ...
    !   paramformats, resultformat) result(pgresult)
    function execprepared(conn, stmtname, nparams, paramvalues, resultformat) result(pgresult)
      ...
      pgresult%ptr = pqexecprepared(conn &
        , c_str(stmtname)                &
        , int(nparams, kind=c_int)       &
        , c_loc(paramvalues)             &
        , c_null_ptr                     &
    ...
    function describeprepared(conn, stmtname) result(pgresult)
      ...
      pgresult%ptr = pqdescribeprepared(conn, c_str(stmtname))
    ...
    function describeportal(conn, portalname) result(pgresult)
      ...
      type(pq) :: pgresult
        ...
        !! and the functions [[nfields]], [[fname]], [[ftype]], etc provide information about
        !! the result columns (if any) of the statement.
      pgresult%ptr = pqdescribeportal(conn, c_str(portalname))
    ...
    function resstatus(status) bind(c, name='PQresStatus') result(r)
    ...
    function resulterrormessage(pgresult) bind(c, name='PQresultErrorMessage') result(r)
    ...
    function resulterrorfield(pgresult, fieldcode) bind(c, name='PQresultErrorField') result(r)
    ...
    subroutine clear(pgresult) bind(c, name='PQclear')
    ...
    function ntuples(pgresult) bind(c, name='PQntuples') result(r)
    ...
    function nfields(pgresult) bind(c, name='PQnfields') result(r)
    ...
    function fname(pgresult, column_number) bind(c, name='PQfname') result(r)
    ...
    function fnumber(pgresult, column_name) bind(c, name='PQfnumber') result(r)
    ...
    function ftablecol(pgresult, column_number) bind(c, name='PQftablecol') result(r)
    ...
    function fformat(pgresult, column_number) bind(c, name='PQfformat') result(r)
    ...
    function fsize(pgresult, column_number) bind(c, name='PQfsize') result(r)
    ...
    function binarytuples(pgresult) bind(c, name='PQbinaryTuples') result(r)
    ...
    function getvalue(pgresult, row_number, column_number) bind(c, name='PQgetvalue') result(r)
    ...
    function getisnull(pgresult, row_number, column_number) bind(c, name='PQgetisnull') result(r)
    ...
    function getlength(pgresult, row_number, column_number) bind(c, name='PQgetlength') result(r)
